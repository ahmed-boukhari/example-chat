...
function App() {
  ...
  // Model configuration
  const [modelId, setModelId] = useState('HuggingFaceTB/SmolLM2-1.7B-Instruct');
      ...
      {status === null && messages.length === 0 && (
        <div className="h-full overflow-auto scrollbar-thin flex justify-center items-center flex-col relative">
          <div className="flex flex-col items-center mb-1 max-w-[250px] text-center">
            ...
            <h1 className="text-4xl font-bold mb-1">LLM</h1>
          </div>

          <div className="flex flex-col items-center px-4 gap-3 w-full max-w-md">
            <div className="w-full">
              ...
              <input
                ...
                placeholder="e.g., HuggingFaceTB/SmolLM2-1.7B-Instruct"
              />
            </div>
            ...
            <div className="w-full">
              ...
              <input
                ...
                placeholder="e.g., q4f16"
              />
            </div>
            
            <button
              className="border px-4 py-2 rounded-lg bg-blue-400 text-white hover:bg-blue-500 disabled:bg-blue-100 disabled:cursor-not-allowed select-none w-full"
              onClick={() => {
                worker.current.postMessage({ type: 'load', data: {
                  model_id: modelId,
                  dtype: dtype,
                }});
                setStatus('loading');
              }}
              disabled={status !== null || !modelId || !dtype}
            >
              Load model
            </button>
          </div>
